...
const Footer = () => {
    return (
        <footer
            ...
            className="px-4 divide-y bg-white text-gray-900 mt-5">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <Link rel="noopener noreferrer" href="#">Emergency Checkup</Link>
                            </li>
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase text-gray-900">ORAL HEALTH</h3>
                        <ul className="space-y-1">
                            <li>
                                <Link rel="noopener noreferrer" href="#">Fluoride Treatment</Link>
                            </li>
                            <li>
                                <Link rel="noopener noreferrer" href="#">TCavity Filling</Link>
                            </li>
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-gray-900">Our Address</h3>
                        <ul className="space-y-1">
                            <li>
                                <Link rel="noopener noreferrer" href="#">New York - 101010 Hudson,USA</Link>
                            </li>
                            <li>
                                <Link rel="noopener noreferrer" href="#">Dhaka,Bangladesh</Link>
                            </li>
                            <li>
                                <Link rel="noopener noreferrer" href="#">British Colombia ,Canada</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
